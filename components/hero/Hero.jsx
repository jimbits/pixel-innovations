         ...
         <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
           <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
             ...
             <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
               ...
               Flexible online training designed to put you on the fast track to success. Each learning pathway offers proffessional certification from world class universities and companies.
               </p>
               <div className="mt-10 flex items-center gap-x-6">
                 ...
                 <a href="#" className="text-sm font-semibold leading-6 text-gray-900">
                  Learning pathways <span aria-hidden="true">→</span>
                 </a>
               </div>
             </div>
             <img
 ...
 function PageHeader ( {children}){
    return (
       <header>
        <h1 className="text-2xl font-semibold">Grow your skills and advance careerGet professional-level training from Google</h1>
